...
globals [
  ...
  n ;count rounds based on number of landscape files
  step ;item to import landscape (need to be different to 'n' because the list starts at 0, then in the end of simulation step will be equal to n - 1.)
]

patches-own [
  cover ;habitat or matrix
  Q ;habitat quality
]
...
to go
  ...
  create_hab_quality_surface ;create habitat quality surface
